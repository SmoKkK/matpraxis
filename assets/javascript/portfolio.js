...
$(document).ready(() => {
  const links = [
    ...
    {
      name: 'Buy Premium',
      link: 'https://discord.gg/q4yjwuhHqP',
    },
    {
  ...
  app.titleChanger(['Matpraxis', 'By SmoK/Zeta', 'Bypassing all screenshare tools']);
  app.iconChanger(['assets/icons/roses/rose1.jpg', 'assets/icons/roses/rose2.jpg', 'assets/icons/roses/rose3.jpg']);
});
